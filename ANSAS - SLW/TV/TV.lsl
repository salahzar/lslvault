...
pictures()      //Change mode to Picture Viewer
{
    ...
    // NOT WORKING in 073 PRIM_BUMP_SHINY,DISPLAY_ON_SIDE,PRIM_SHINY_NONE,PRIM_BUMP_NONE,
    PRIM_COLOR,DISPLAY_ON_SIDE,<1,1,1>,1.0,PRIM_MATERIAL,PICTURE_MATERIAL]);
    llSetColor(<0,0,0>,0);
...
{
    report("starting video mode "+(string)DISPLAY_ON_SIDE);
    //Change prim to Light material while coloring face 0 black to prevent light-lag generation.
    // NOT working in 073 llSetLinkPrimitiveParamsFast(1,[PRIM_BUMP_SHINY,DISPLAY_ON_SIDE,0,0]);
    
    llSetLinkPrimitiveParamsFast(1,[PRIM_COLOR,DISPLAY_ON_SIDE,<1.0,1.0,1.0>,1.0]);
    
    llSetLinkPrimitiveParamsFast(1,[PRIM_MATERIAL,VIDEO_MATERIAL]);
    
    llSetLinkPrimitiveParamsFast(1,[PRIM_TEXTURE,DISPLAY_ON_SIDE,"62dc73ca-265f-7ca0-0453-e2a6aa60bb6f",llGetTextureScale(DISPLAY_ON_SIDE),llGetTextureOffset(DISPLAY_ON_SIDE),llGetTextureRot(DISPLAY_ON_SIDE)
]);
...
off()
{
    ...
    llSetPrimitiveParams([
         // NOT WORKING in 073 PRIM_BUMP_SHINY,DISPLAY_ON_SIDE,PRIM_SHINY_LOW,PRIM_BUMP_NONE,
         PRIM_COLOR,DISPLAY_ON_SIDE,<0.1,0.1,0.1>,1.0,PRIM_MATERIAL,PRIM_MATERIAL_PLASTIC,PRIM_TEXTURE,DISPLAY_ON_SIDE,BLANK,llGetTextureScale(DISPLAY_ON_SIDE),llGetTextureOffset(DISPLAY_ON_SIDE),llGetTextureRot(DISPLAY_ON_SIDE)]);
}
